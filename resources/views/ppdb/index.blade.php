                    ...
                    <ul class="my-4"style="list-style-type: none;">
                        <li class="my-8" >
                            <div class="row items-center justify-content-center">
                                ...
                                <div class="col-10">
                                    <div class="text-2xl">Multi Jalur Seleksi</div>
                                    <p>Penyesuaian jalur seleksi sesuai dengan kondisi</p>
                                </div>
                            </div>
                        </li>
                        <li class="my-8" >
                            <div class="row items-center justify-content-center">
                                ...
                                <div class="col-10">
                                    <div class="text-2xl">Multi Model Pendaftaran</div>
                                    <p>Berbagai macam model pendaftaran yang dapat dipilih untuk mensukseskan implementasi
                                        PPDB
                                    </p>
                                </div>
                            </div>
