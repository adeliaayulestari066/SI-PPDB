...
<head>
    ...
    <title>@yield('title', 'TK Al-Muchlis')</title>
    ...
    <!-- Other head elements -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" integrity="sha384-k6RqeWeci5ZR/Lv4MR0sA0FfDOMTd/6eELxZ7x8vix9I1QIk0c7/z2IsfQAc0Z+d" crossorigin="anonymous">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="/data-siswa" class="menu-link">
                            ...
                            <div data-i18n="Basic">Manajemen Data Siswa</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        ...
                        <footer class="content-footer footer bg-footer-theme">
                            <div
                                ...
                                <div class="mb-2 mb-md-0">
                                    ...
                                    <a href="" target="_blank" class="footer-link fw-bolder">TK Al-Muchlis</a>
                                </div>
                            </div>
                        </footer>
                        <!-- / Footer -->
