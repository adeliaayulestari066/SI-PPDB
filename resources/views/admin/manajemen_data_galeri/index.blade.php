            ...
            <div class="dt-action-buttons text-end pt-3 pt-md-0">
                <div class="dt-buttons">
                    <button class="dt-button create-new btn btn-primary" tabindex="0"
                        ...
                        onclick="window.location.href='/data-galeri/tambah'">
                        <span>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('data-galeri.lihat', $galeri->id) }}">
                                        <i class="bx bx-show me-1"></i> Detail Galeri
                                    </a>                                    
                                    <a class="dropdown-item" href="/galeri/{{ $galeri->id }}/edit">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form id="formHapusGaleri" action="{{ route('data-galeri.hapus', ['galeri' => $galeri->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
